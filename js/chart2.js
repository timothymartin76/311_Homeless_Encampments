    ...
    var apiCall = "https://timothymartin76.cartodb.com/api/v2/sql?format=json&q=SELECT date_trunc('month', created_date) AS \"month\" , count(*) AS \"complaints\" FROM homelessenc2 GROUP BY 1 ORDER BY 1";
    var cartodbData = [];
